            ...
            <div class="header-right hstack gap-3">
                ...
                <div class="hstack gap-0 gap-sm-1">
                            ...
                            <div class="card mb-0">
                                ...
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h6 class="m-0 fs-5 fw-semibold">My Cart <span
                                                class="badge bg-secondary ms-1">7</span></h6>
                                ...
                                <div class="header-cart-scrollable card-body px-0 py-2" data-simplebar>
                                    ...
                                    <div class="dropdown-item d-flex align-items-center gap-3 py-2">
                                        <img src="{{ asset('assets/images/product/product-3.jpg') }}"
                                            class="img-fluid rounded-3 avatar-lg" loading="lazy"
                                            alt="SoundMaster Wireless Headphones">
                                        <div class="flex-grow-1 text-truncate">
                                            <a href="apps-product-details" class="text-body fw-semibold">SoundMaster
                                                Wireless Headphones</a>
                                            <div class="text-muted fs-7 text-truncate">Both fashion and functionality
                                            </div>
                                        </div>
                                    ...
                                    <!-- Cart Item 2 -->
                                    <div class="dropdown-item d-flex align-items-center gap-3 py-2">
                                        <img src="{{ asset('assets/images/product/product-4.jpg') }}"
                                            class="img-fluid rounded-3 avatar-lg" loading="lazy" alt="Cocooil Body Oil">
                                        <div class="flex-grow-1 text-truncate">
                                            <a href="apps-product-details" class="text-body fw-semibold">Cocooil Body
                                                Oil</a>
                                            <div class="text-muted fs- text-truncate">Natural and nourishing body oil
                                            </div>
                                        </div>
                                    ...
                                    <!-- Cart Item 3 -->
                                    <div class="dropdown-item d-flex align-items-center gap-3 py-2">
                                        <img src="{{ asset('assets/images/product/product-6.jpg') }}"
                                            class="img-fluid rounded-3 avatar-lg" loading="lazy"
                                            alt="Luxury Sunglasses">
                                        <div class="flex-grow-1 text-truncate">
                                            <a href="apps-product-details" class="text-body fw-semibold">Luxury
                                                Sunglasses</a>
                                            <div class="text-muted fs- text-truncate">Stylish and durable sunglasses
                                            </div>
                                        </div>
                                ...
                                <div class="card-footer border-top">
                                    ...
                                    <a href="apps-product-checkout"
                                        class="btn btn-primary text-center w-100 mt-3">Proceed to Checkout</a>
                                </div>
                    ...
                    {{-- <div class="dropdown features-dropdown" id="language-dropdown">
                        <a href="#!" class="btn icon-btn btn-text-primary rounded-circle"
                            data-bs-toggle="dropdown" aria-expanded="false">
                            <div class="avatar-item avatar-xs">
                                <img class="img-fluid avatar-xs" src="{{ asset('assets/images/flags/us.svg') }}"
                        ...
                        <div class="dropdown-menu header-language-scrollable dropdown-menu-end" data-simplebar>
                            ...
                            <a href="#!" class="dropdown-item">
                                <img src="{{ asset('assets/images/flags/es.svg') }}" alt="es" loading="lazy"
                                    class="me-2 rounded h-20px w-20px img-fluid object-fit-cover">
                                <span class="align-middle">Spanish</span>
                            </a>

                            <a href="#!" class="dropdown-item">
                                <img src="{{ asset('assets/images/flags/fr.svg') }}" alt="fr" loading="lazy"
                                    class="me-2 rounded h-20px w-20px img-fluid object-fit-cover">
                                <span class="align-middle">French</span>
                            </a>

                            <a href="#!" class="dropdown-item">
                                <img src="{{ asset('assets/images/flags/ru.svg') }}" alt="ru" loading="lazy"
                                    class="me-2 rounded h-20px w-20px img-fluid object-fit-cover">
                                <span class="align-middle">Russian</span>
                            </a>

                            <a href="#!" class="dropdown-item">
                                <img src="{{ asset('assets/images/flags/de.svg') }}" alt="de" loading="lazy"
                                    class="me-2 rounded h-20px w-20px img-fluid object-fit-cover">
                                <span class="align-middle">German</span>
                            </a>

                            <a href="#!" class="dropdown-item">
                                <img src="{{ asset('assets/images/flags/it.svg') }}" alt="it" loading="lazy"
                                    class="me-2 rounded h-20px w-20px img-fluid object-fit-cover">
                                <span class="align-middle">Italian</span>
                            </a>

                            <a href="#!" class="dropdown-item">
                                <img src="{{ asset('assets/images/flags/zh.svg') }}" alt="zh" loading="lazy"
                                    class="me-2 rounded h-20px w-20px img-fluid object-fit-cover">
                                <span class="align-middle">Chinese</span>
                            </a>

                            <a href="#!" class="dropdown-item">
                                <img src="{{ asset('assets/images/flags/ar.svg') }}" alt="ar" loading="lazy"
                                    class="me-2 rounded h-20px w-20px img-fluid object-fit-cover">
                    ...
                    <div class="dropdown features-dropdown">
                        <button type="button" class="btn icon-btn btn-text-primary rounded-circle position-relative"
                            ...
                            <span
                                class="position-absolute translate-middle badge rounded-pill p-1 min-w-20px badge text-bg-danger">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                            ...
                            <div class="dropdown-header d-flex align-items-center py-3">
                                ...
                                <div class="d-flex align-items-center h6 mb-0">
                                    <span class="badge bg-primary-subtle text-primary me-2">{{ Auth::user()->unreadNotifications->count() }} New</span>
                                </div>
                            </div>
                            <ul class="list-group list-group-flush header-notification-scrollable" data-simplebar>
                                @forelse(Auth::user()->notifications->take(10) as $notification)
                                    <li class="list-group-item list-group-item-action border-start-0 border-end-0 {{ $notification->read_at ? '' : 'bg-light' }}">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 me-3">
                                                @if(isset($notification->data['type']) && $notification->data['type'] == 'low_stock')
                                                    <div class="avatar-item avatar avatar-title bg-danger-subtle text-danger rounded-circle">
                                                        <i class="ri-error-warning-fill"></i>
                                                    </div>
                                                @else
                                                    <div class="avatar-item avatar avatar-title bg-primary-subtle text-primary rounded-circle">
                                                        {{ strtoupper(substr($notification->data['message'] ?? 'N', 0, 1)) }}
                                                    </div>
                                                @endif
                                            </div>
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1 small fw-semibold">{{ $notification->data['type'] == 'low_stock' ? 'Low Stock Alert' : 'Notification' }}</h6>
                                ...
                                @empty
                                    <li class="list-group-item text-center py-4 bg-transparent border-0">
                                        <div class="avatar avatar-title bg-light text-muted rounded-circle mb-3 mx-auto">
                            ...
                            <div class="p-2 border-top text-center">
                                <a class="btn btn-sm btn-link text-primary fw-medium" href="javascript:void(0);">
                                    <i class="ri-arrow-right-s-line align-middle"></i> View All Notifications
                                </a>
                            </div>
                        </div>
                    </div>
